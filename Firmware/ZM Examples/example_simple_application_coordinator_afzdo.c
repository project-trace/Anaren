...
#define MODULE_START_DELAY_IF_FAIL_MS 5000
        ...
        case STATE_DISPLAY_NETWORK_INFORMATION:
        {
            ...
            printf("    None = None\r\n");
            printf("    Yellow (D6) = IR Temp Sensor\r\n");
            printf("    Red (D5) = Color Sensor\r\n");
...
#define IS_INFO_MESSAGE_CLUSTER()  (CONVERT_TO_INT(zmBuf[AF_INCOMING_MESSAGE_CLUSTER_LSB_FIELD], zmBuf[AF_INCOMING_MESSAGE_CLUSTER_MSB_FIELD]) == INFO_MESSAGE_CLUSTER)
